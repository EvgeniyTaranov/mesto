export class FormValidator {
  ...
  _disableSaveButton() {
    this._buttonElement.classList.add(this._validationConfig.inactiveSaveButtonClass);
    this._buttonElement.disabled = true;
  }

  _enableSaveButton() {
    this._buttonElement.classList.remove(this._validationConfig.inactiveSaveButtonClass);
